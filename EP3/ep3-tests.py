...
def main():
        ...
        MDP1 = ep3.BlackjackMDP(valores_cartas=[1, 5], multiplicidade=2, limiar=10, custo_espiada=1)
        MDP2 = ep3.BlackjackMDP(valores_cartas=[1, 5], multiplicidade=2, limiar=15, custo_espiada=1)
        ...
        print('=================PARTE 03.1=================')
        qLearning = ep3.QLearningAlgorithm(MDP1.actions, MDP1.discount(), identityFeatureExtractor, 0)
